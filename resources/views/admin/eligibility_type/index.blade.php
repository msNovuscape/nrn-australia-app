                                    ...
                                    @foreach($settings as $setting)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center action-icons">
                                                <a href="{{url('admin/eligibility_types/'.$setting->id.'/edit')}}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="edit">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <a href="{{url('admin/eligibility_types/delete/'.$setting->id)}}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="delete" onclick="return confirm('Are you sure want to delete?')">
