            ...
            <div class="container-fluid p-0">
                ...
                <div class="card mb-0">
                    <div class="card-header">
                        <h3 class="card-title">Create Team Period</h3>
                        <a href="{{url('admin/team_period')}}" class="back-button btn-create">List</a>
                    </div>
                    <div class="card-body pt-0">
                        @include('success.success')
                        @include('errors.error')
                        {!! Form::open(['url' => '/admin/team_period', 'class' => 'form-horizontal', 'method'=> 'POST','files' => true]) !!}
                        <div class="row">

                            <div class="col-md-6" >
                                <div class="form-group" >
                                    <label class="w-100">From Year <span style="color: red";> * </span></label>
                                    <input type = "date" value = "{{old('from_date')}}" name="from_date" class="form-control" rows="4" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6" >
                                <div class="form-group" >
                                    ...
                                    <input type = "date" value = "{{old('to_date')}}" name="to_date" class="form-control" rows="4" required/>
                                </div>
                            </div>
