            ...
            <div class="container-fluid p-0">
                ...
                <div class="card mb-0">
                    <div class="card-header">
                        ...
                        <a href="{{url('admin/document_category')}}" class="back-button btn-create">List</a>
                    </div>
                    <div class="card-body pt-0">
                        @include('success.success')
                        @include('errors.error')
                        {!! Form::open(['url' => '/admin/document_category', 'class' => 'form-horizontal', 'method'=> 'POST','files' => true]) !!}
                        <div class="row">
