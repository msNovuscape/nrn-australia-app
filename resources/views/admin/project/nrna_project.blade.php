@if(isset($setting))
    <div class="col-md-12 my_section" >
        <div class="form-group" >
            ...
            <textarea name="description" id="body1" rows="5" required style="height: 658px;" >{!! $setting->nrn_project->description !!}</textarea>
        </div>
    </div>
    <div class="col-md-4 my_section" >
        <div class="form-group">
            <label> Image Caption </label>
            <input type="text" class="form-control"  name="image_caption" value="{{$setting->nrn_project->image_caption}}">
        </div>
    </div>
    <div class="col-md-4 my_section" >
        <div class="form-group">
            <label> Image Credit </label>
            <input type="text" class="form-control"   name="image_credit" value="{{$setting->nrn_project->image_credit}}">
        </div>
    </div>
    <div class="col-md-4 my_section" >
        <div class="form-group">
            <label>Image alt</label>
            <input type="text" class="form-control"   name="image_alt" value="{{$setting->nrn_project->image_alt}}">
        </div>
    </div>
    <div class="col-md-6 my_section" >
        <div class="form-group">
            <label>Seo Title</label>
            <input type="text" class="form-control"   name="seo_title" value="{{$setting->nrn_project->seo_title}}">
        </div>
    </div>
    <div class="col-md-6 my_section" >
        <div class="form-group">
            <label> Keyword</label>
            <input type="text" class="form-control"   name="keyword" value="{{$setting->nrn_project->keyword}}">
        </div>
    </div>
    <div class="col-md-6 my_section" >
        <div class="form-group">
            <label>Seo Description </label>
            <textarea id="body2" name="seo_description">{!! $setting->nrn_project->seo_description !!}</textarea>
        </div>
    </div>
    <div class="col-md-6 my_section" >
        <div class="form-group">
            <label>Meta Keyword</label>
            <textarea id="body3" name="meta_keyword" >{!! $setting->nrn_project->meta_keyword !!}</textarea>
        </div>
    </div>
@else
    <div class="col-md-12 my_section" >
