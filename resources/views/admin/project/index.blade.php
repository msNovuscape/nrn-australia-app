                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-create" href="{{url('admin/projects/create')}}" role="button">Create</a>
                                </div>
                            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($settings as $setting)
                                        <tr>
                                            ...
                                            <th scope="row" class="text-center">{{config('custom.project_types')[$setting->project_type]}}</th>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center action-icons">
                                                    ...
                                                    <a href="{{url('admin/projects/delete/'.$setting->id)}}" class="btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="delete" onclick="return confirm('Are you sure want to delete?')">
