                            ...
                            <div class="card-header">
                                <h3 class="card-title">Client Table</h3>
                                    <div class="card-tools">
                                        <a class="btn btn-primary" href="{{url('admin/clients/create')}}" role="button">Create</a>
                                    </div>
                                </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach($settings as $setting)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary btn-sm" href="{{url('admin/clients/'.$setting->id)}}">
                                                        <i class="fas fa-folder">
                                                        </i>
                                                        View
                                                    </a>
                                                    <a class="btn btn-info btn-sm" href="{{url('admin/clients/'.$setting->id.'/edit')}}">
