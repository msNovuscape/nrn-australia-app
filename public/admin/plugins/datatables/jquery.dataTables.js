...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		 ...
		 * previous, first or last services.
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of services of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} services` The number of services in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, services ) {
